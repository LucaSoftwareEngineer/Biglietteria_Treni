...
function menuSidebarActive() {
  $(".main-panel").css({"margin-left": "50px"});
  $(".icon-menu").removeClass('menu-active');
  $(".icon-menu").addClass('menu-disactive');
  $(".menu-disactive").click(function () {
    menuSidebarDisactive();
  });
}

function menuSidebarDisactive() {
  $(".main-panel").css({"margin-left": "200px"});
  $(".icon-menu").addClass('menu-active');
  $(".icon-menu").removeClass('menu-disactive');
  $(".menu-active").click(function () {
    menuSidebarActive();
  });
}